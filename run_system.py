...
def main():
    ...
    try:        # Jalankan sensor.py dengan output disimpan ke file terpisah
        sensor_cmd = "docker exec -it mlff_bitah python3 /home/ros_ws/sensor.py"
        ...
        detector_cmd = "docker exec -it mlff_bitah python3 /home/ros_ws/bismillah_pengujian_fixed.py"
        ...
        subscriber_cmd = "docker exec -it mlff_bitah python3 /home/ros_ws/subscriber.py"
